...
import olova from "@/assets/images/olova-B0FjVVEL.jpg";
import dataflow from "@/assets/images/dataflow.jpeg"
  ...
  const projects = [
    {
      ...
      description:
        "I hardened a Windows virtual machine by applying Microsoft's security baseline using LGPO and Policy Analyzer. I tested and verified that the settings prevented unauthorized actions, such as access to Control Panel and running unsigned applications.",
      tags: ["Windows Server, Group Policy, LGPO Tool, Policy Analyzer"],
      category: "Windows",
      links: {
        github: "https://github.com/alirzas1",
        demo: "",
      },
      image: olova,
      featured: false,
    ...
    {
      title: "Secure Network Design with VLANs and OSPF",
      description:
        "I designed and simulated a segmented network using VLANs for isolation and OSPF for dynamic routing. The network included firewall rules and ACLs to control access between departments",
      tags: ["Cisco Packet Tracer, OSPF, VLAN, ACL, Switch & Router configs"],
      category: "Cisco",
      links: {
        github: "https://github.com/alirzas1",
        demo: "",
    ...
    {
      title: "Virtual Security Lab Setup",
      description:
        "I built a virtual lab using Proxmox and Kali Linux to test security tools, simulate attacks, and study defense techniques in a controlled environment.",
      tags: ["Proxmox, Kali Linux, pfSense, Windows Server, ZFS Snapshots"],
      category: "Linux",
      links: {
        github: "https://github.com/alirzas1",
        demo: "https://github.com/alirzas1",
      },
      image: terminal,
      featured: false,
    },
