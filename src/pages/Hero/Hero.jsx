...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'Alireza Saljoghi',
    title: 'Cyber Security Student | Cloud Enthusiast | Problem Solver',
    skills: [
        'React', 'NextJS', 'HTML5', 'Cisco Packet Tracer'
        'MongoDB', 'Docker', 'AWS', 'Git', 'Linux'
    ],
    quickLearner: true,
    problemSolver: true,
    yearsOfExperience: 1, 
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/alireza-s-062246b1/"
                  className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 p-0.5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-black-400">
